<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact Us.aspx.cs" Inherits="BABY_COLLECTION.ContactUs" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="container">
           ...
           <asp:TextBox ID="fname" class="con" name="firstname"  placeholder="Your First name.."  type="text" runat="server"></asp:TextBox>

          <label for="lname">Last Name</label>
           <asp:TextBox ID="lname"  class="con" name="lastname"  placeholder="Your Last name.."  type="text" runat="server"></asp:TextBox>

          <label for="country">Country</label>
        <asp:TextBox ID="country"  class="con" name="country"  placeholder="Your Country"  type="text" runat="server"></asp:TextBox>
         
          <label for="subject">Subject</label>
          <asp:TextBox ID="subject" class="con"  name="subject"  placeholder="Give us feedback"   style="height: 200px" type="text" runat="server"></asp:TextBox>
