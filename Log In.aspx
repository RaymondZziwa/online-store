<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Log In.aspx.cs" Inherits="BABY_COLLECTION.LogIn" %>
...
<body>
              ...
              <div class="formbg-inner padding-horizontal--48">
                ...
                <form id="stripe-login">
                  <div class="field padding-bottom">
                    <asp:TextBox ID="username" runat="server" type="text" name="username" class="input"></asp:TextBox>
                  </div>
                  <div class="field padding-bottom--24">
                    ...
                    <asp:TextBox ID="pwd" runat="server" type="password" name="password" class="input"></asp:TextBox>
                  </div>
                  <div
                    class="
   ...
   Stay signed in
                  ...
                  <div class="field padding-bottom--24">
                   <asp:Button ID="login" type="submit" runat="server" name="submit" Text="Log In"  class="btn btn-outline-success" OnClick="login_Click"/>
                  </div>
                  <div class="field">
            ...
            <div class="footer-link padding-top--24">
              <span>Don't have an account? <a href="Sign Up.aspx">Sign up</a></span>
              <div
                class="
                  listing
                  padding-top--24
                ...
                "
              >
                <span><a href="#">© Baby Collection</a></span>
